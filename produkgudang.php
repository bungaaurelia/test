	...
	<div id="menu">
     <table border="2" align="center" width="700"> 
		<tr><td><li><a href='homeadmin.php'>Home</a></li></td>
			<td rowspan="11" align="center"><h2>Produk</h2>		  
		<?php
		  include "config/conn.php";
          echo "<a href='tambahprodukgudang.php'>Tambah Produk Gudang</a>";
		...
		$no=1;
		$view= $mysqli->query("SELECT * FROM produk");
		...
		echo "<tr><td>$no</td>
				...
				<td>$a[harga]</td>
				<td>$a[stok]</td>
				<td><a href='editproduk.php?id=$a[nama_produk]'>Edit</a> | 
					<a href='delproduk.php?id=$a[nama_produk]'>Delete</a></td>";
		$no++;
		}
		echo"</tr></table>";
		
		echo "<a href='hubsupplier.php'>Hubungi Supllier</a>";
			?>
