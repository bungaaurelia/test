...
<div id="main_container">
       ...
       <div id="menu_tab">
            <div class="left_menu_corner"></div>
              <ul class="menu">
                ...
                <li class="divider"></li>
		            <li><a href="produk.php" class="nav4">Semua Produk</a></li>
                <li class="divider"></li>
  ...
  <div class="crumb_navigation">
    Anda sedang berada di: <span class='current'>Profil</span>  </div>        
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Profil Fashion Store</div>
              <div><strong>Fashion Store&nbsp;</strong>merupakan website resmi&nbsp;<br />
Kami menjual pakaian wanita dari kaos, kemeja, celana, sweater, rok dan gamis dengan harga terjangkau namun tetap berkualitas dan terpercaya.
</div>
          </div>    
          </div>
