	...
	<div id="menu">
     <table border="2" align="center" width="700"> 
		<tr><td><li><a href='homeadmin.php'>Home</a></li></td>
			<td rowspan="11" align="center"><h2>Kategori</h2>		  
		<?php
		  include "config/conn.php";
          echo "<a href='tambahkategori.php'>Tambah Kategori</a>";
		...
		$no=1;
		$view= $mysqli->query("SELECT * FROM kategori");
		while ($a=mysqli_fetch_array($view)) {
		echo "<tr><td>$no</td>
				<td>$a[nama_kategori]</td>
				<td><a href='editkategori.php?id=$a[id_kategori]'>Edit</a> | 
					<a href='delkategori.php?id=$a[nama_kategori]'>Delete</a></td>";
		$no++;
		}
		echo"</tr></table>";
			?>
