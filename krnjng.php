...
<div id="main_container">
  ...
  <div class="crumb_navigation">
    Anda sedang berada di: <span class='current'>Katalog</span>  </div>        
  ...
  <div class="left_content"> 
    ...
    <div class="title_box">Kategori</div>    
      <ul class="left_menu">
			...
			<li class='genap'><a href='tunik.phpl'> Tunik (4)</a></li>  
		</ul>
...
<div class='center_title_bar'>Keranjang Belanja</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <th>Harga</th><th>Sub Total</th><th>Hapus</th></tr><tr bgcolor=#dad0d0><td>1</td><input type=hidden name=id[1] value=132>
              <td align=center><br><img src=produk/cln1.jpg height="110"></td>
              <td>Hilo Jumbo</td>
       			  <td align=center>2.00</td>
              <td><select name='jml[1]' value=2 onChange='this.form.submit()'><option>1</option><option selected>2</option><option>3</option><option>4</option><option>5</option></select></td>
              <td>50.000</td>
              <td>100.000</td>
              <td align=center><a href='aksi.php?module=keranjang&act=hapus&id=132'>
              <img src=image/kali.png border=0 title=Hapus></a></td>
          </tr><tr><td colspan=6 align=right><br><b>Total</b>:</td><td colspan=2><br>Rp. <b>100.000</b></td></tr>
